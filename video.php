        ...
        <div id="videobox">
            <div class="videos clearfix">
                <div class="vs">
                    <div>
                        <div class="border">
                            <video src="http://tv.haojialian123.com/files/video-manner.mp4" poster="images/video-manner.jpg" id="video0"></video>
                        </div>
                    </div>
                    <p>礼仪礼节篇</p>
                </div>
                <div class="vs">
                    <div>
                        <div class="border">
                            <video src="http://tv.haojialian123.com/files/video-training.mp4" poster="images/video-training.jpg" id="video1"></video>
                        </div>
                    </div>
                    <p>岗前培训篇</p>
                </div>
